...
GITHUB = 'github.com/csgo-league/csgo-league-bot'
...
class HelpCog(commands.Cog):
    ...
    def __init__(self, bot, color):
        ...
        self.bot = bot
        self.color = color
        self.thumbnail_url = 'https://raw.githubusercontent.com/csgo-league/csgo-league-bot/master/assets/logo/rounded_logo.png'
    ...
    async def info(self, ctx):
        ...
        github_link = '[Source code can be found here on GitHub](https://github.com/csgo-league/csgo-league-bot)'
